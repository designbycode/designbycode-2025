...
use App\Livewire\Pages\Packages\PackageShow;
use App\Livewire\Pages\Packages\PackagesIndex;
...
Route::get('/packages/{package:slug}', PackageShow::class)->name('packages.show');
