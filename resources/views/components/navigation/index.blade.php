        ...
        <div class="flex space-x-4 items-center text-sm text-neutral-200 group  duration-150">
            ...
            <div x-data="themeSwitcher()" class="relative">
                <button @click="dropdownOpen = !dropdownOpen"
                        title="Select theme"
                        class="flex items-center justify-center w-10 h-10 text-neutral-200 hover:text-primary-500 focus:outline-none rounded-full hover:bg-neutral-700">
                ...
                <div x-show="dropdownOpen"
                     ...
                     class="absolute right-0 mt-2 w-40 bg-neutral-700 border border-neutral-600 rounded-md shadow-lg py-1 z-50"
                     x-cloak>
                    <a @click.prevent="setTheme('light')" href="#"
                       :class="{'bg-neutral-600 text-primary-400': theme === 'light'}"
                       class="flex items-center px-4 py-2 text-sm text-neutral-200 hover:bg-neutral-600 hover:text-primary-400">
                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        Light
                    </a>
                    <a @click.prevent="setTheme('dark')" href="#"
                       :class="{'bg-neutral-600 text-primary-400': theme === 'dark'}"
                       class="flex items-center px-4 py-2 text-sm text-neutral-200 hover:bg-neutral-600 hover:text-primary-400">
                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>
                        Dark
                    </a>
                    <a @click.prevent="setTheme('system')" href="#"
                       :class="{'bg-neutral-600 text-primary-400': theme === 'system'}"
                       class="flex items-center px-4 py-2 text-sm text-neutral-200 hover:bg-neutral-600 hover:text-primary-400">
                        <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        System
                    </a>
                </div>
            </div>
