...
use Intervention\Image\Facades\Image; // Assuming Intervention Image is installed and aliased
use Illuminate\Support\Facades\File;
use Illuminate\Support\Str;
use Illuminate\Support\Facades\Storage; // For streamDownload and clean up
